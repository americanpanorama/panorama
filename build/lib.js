...
},{"cssify":4}],4:[function(require,module,exports){
...
var PanoramaChart = (function (_React$Component) {
  ...
  _createClass(PanoramaChart, [{
    ...
    value: function update() {
      if (!_charts.charts[this.props.type]) return console.error('No chart for type: ' + this.props.type);
      if (!this.chart) {
        this.chart = new _charts.charts[this.props.type](d3.select(_react2['default'].findDOMNode(this.refs.chart)));
      }
...
},{"./charts":8,"./style.scss":9,"react":"react"}],8:[function(require,module,exports){
'use strict';
...
var Axis = (function (_Koto) {
  ...
  _createClass(Axis, [{
    key: 'update',
    value: function update() {
      this.axis.scale(this.configs['scale'].value).ticks(this.configs['ticks'].value).orient(this.configs['orient'].value);
...
var ChartBase = (function (_Koto2) {
  _inherits(ChartBase, _Koto2);

  function ChartBase(selection) {
    ...
    this.xScale = _d32['default'].scale.ordinal();
    this.yScale = _d32['default'].scale.linear();
  }
...
var DiscreteBarChart = (function (_ChartBase) {
  _inherits(DiscreteBarChart, _ChartBase);

  function DiscreteBarChart(selection) {
    _classCallCheck(this, DiscreteBarChart);

    _get(Object.getPrototypeOf(DiscreteBarChart.prototype), 'constructor', this).call(this, selection);
    var _Chart = this;
    ...
    var layer = this.layer('bars', bars, {
      ...
      insert: function insert() {
        return this.append('rect').attr('class', 'bar').attr("width", _Chart.xScale.rangeBand());
      }
    });
    ...
    layer.on('enter', function () {
      return this.attr("x", function (d) {
        ...
        return _Chart._height - _Chart.yScale(_Chart.accessor('y')(d));
      });
    }).on('merge', function () {
      // this => base selection
    }).on('exit', function () {
  ...
  _createClass(DiscreteBarChart, [{
    ...
    value: function updateScales(data) {
      ...
      this.yScale.domain([0, _d32['default'].max(data, function (d) {
...
},{"d3":1,"koto":2}],9:[function(require,module,exports){
module.exports = require('sassify')('.panorama.barchart {   position: relative; }   .panorama.barchart .bar {     fill: steelblue; }   .panorama.barchart .bar:hover {     fill: brown; }   .panorama.barchart .axis {     font: 10px sans-serif; }   .panorama.barchart .axis path,   .panorama.barchart .axis line {     fill: none;     stroke: #000;     shape-rendering: crispEdges; }   .panorama.barchart .x.axis path {     display: none; } ');;
},{"sassify":3}],10:[function(require,module,exports){
'use strict';
...
},{"./style.scss":11,"d3":1,"react":"react"}],11:[function(require,module,exports){
module.exports = require('sassify')('.panorama.punchcard {   height: 100%;   overflow-x: hidden;   overflow-y: scroll; }   .panorama.punchcard h2, .panorama.punchcard h3 {     margin-bottom: 0; }   .panorama.punchcard .header {     margin-bottom: 20px; }   .panorama.punchcard .subtitle {     display: inline-block; }   .panorama.punchcard .caption {     display: inline-block;     float: right; }   .panorama.punchcard .category {     margin-bottom: 20px; }     .panorama.punchcard .category h4 {       width: 45%;       display: inline-block;       vertical-align: top;       margin-top: 0;       margin-bottom: 0;       margin-right: 5%; }     .panorama.punchcard .category svg {       width: 50%;       display: inline-block;       shape-rendering: \'crispEdges\'; } ');;
},{"sassify":3}],"@panorama/toolkit":[function(require,module,exports){
...
var _PanoramaChartPanoramaChartJsx = require('./PanoramaChart/PanoramaChart.jsx');

var _PanoramaChartPanoramaChartJsx2 = _interopRequireDefault(_PanoramaChartPanoramaChartJsx);

exports.PanoramaChart = _PanoramaChartPanoramaChartJsx2['default'];

},{"./Legend/Legend.jsx":5,"./PanoramaChart/PanoramaChart.jsx":7,"./Punchcard/Punchcard.jsx":10}]},{},[]);
